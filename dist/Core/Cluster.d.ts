...
export declare class Cluster extends EventEmitter {
     ...
     */
    spawn(spawnTimeout?: number, token?: string, data?: any): Promise<Child | Worker>;
    /**
     ...
     */
    respawn({ delay, timeout }?: import("../types/shared").ClusterManagerSpawnOptions): Promise<Worker | Child>;
    /**
